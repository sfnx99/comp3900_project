          ...
          <View style={styles.modalContainer}>
            ...
            <ScrollView style={styles.modalContent}>
              <Text style={styles.modalText}>
                ...
                <Text style={styles.textItalics}>Last Updated: July 8, 2024 {'\n\n'}</Text>
                ...
                <Text style={styles.textBold}> 1. Information We Collect {'\n\n'} </Text>
                ...
                <Text style={styles.textBold}> 2. How We Use Your Information {'\n\n'} </Text>
          ...
          <View style={styles.modalContainer}>
            ...
            <ScrollView style={styles.modalContent}>
              <Text style={styles.modalText}>
                ...
                <Text style={styles.textBold}> 1. Acceptance of Terms {'\n\n'} </Text>
                ...
                <Text style={styles.textBold}> 2. Use of the app {'\n\n'} </Text>
                ...
                <Text style={styles.textBold}>3. User Accounts {'\n\n'}</Text>  
                ...
                <Text style={styles.textBold}>4. Intellectual Property {'\n\n'}</Text>
                ...
                <Text style={styles.textBold}>5. Privacy Policy{'\n\n'}</Text>
                ...
                <Text style={styles.textBold}>6. Changes to Terms{'\n\n'}</Text>
          ...
          <View style={styles.modalContainer}>
            ...
            <ScrollView style={styles.modalContent}>
              <Text style={styles.modalText}>
                ...
                <Text style={styles.textBold}> 1. What Are Cookies? {'\n\n'}</Text>
                ...
                <Text style={styles.textBold}> 2. How We Use Cookies? {'\n\n'}</Text>

                We use cookies for various reasons, including: {'\n\n'}

                <Text style={styles.textBold}> Authentication: </Text>  To keep you logged in and recognize you when you return to our app. {'\n\n'}
                <Text style={styles.textBold}> Preferences: </Text> To remember your settings and preferences. {'\n\n'}

                They are widely used to make websites and apps work more efficiently, as well as to provide information to the owners of the site or app. {'\n\n'}

                <Text style={styles.textBold}> 3. Types of Cookies We Use? {'\n\n'}</Text>

                <Text style={styles.textBold}> Essential Cookies: </Text>  These cookies are necessary for the app to function and cannot be switched off in our systems. {'\n\n'}
                <Text style={styles.textBold}> Performance Cookies </Text> These cookies help us understand how users interact with our app by collecting and reporting information anonymously. {'\n\n'}
                <Text style={styles.textBold}> Functionality Cookies </Text> These cookies allow the app to remember choices you make and provide enhanced, more personalized features. {'\n\n'}
